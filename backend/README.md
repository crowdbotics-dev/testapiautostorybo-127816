...
## Project Structure
    ...
    ├── testapiautostorybo_127816  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_127816`
...
2. Clone this repo and `cd testapiautostorybo_127816`
